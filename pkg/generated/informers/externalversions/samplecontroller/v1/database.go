...
import (
	...
	versioned "github.com/gzlj/samplecontroller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/gzlj/samplecontroller/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/gzlj/samplecontroller/pkg/generated/listers/samplecontroller/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV1().Databases(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV1().Databases(namespace).Watch(options)
			},
		},
...
func (f *databaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecontrollerv1.Database{}, f.defaultInformer)
}
