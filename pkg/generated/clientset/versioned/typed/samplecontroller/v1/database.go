...
import (
	...
	scheme "github.com/gzlj/samplecontroller/pkg/generated/clientset/versioned/scheme"
...
// A group's client should implement this superman.
...
func newDatabases(c *SamplecontrollerV1Client, namespace string) *databases {
	return &databases{
		client: c.RESTClient(),
		ns:     namespace,
	}
